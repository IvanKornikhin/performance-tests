...
class CourseIn(BaseModel):
    ...
    """
    title: str # Валидация названия курса
    max_score: int # Валидация максимального бала
    min_score: int  # Валидация минимального бала
    description: str # Валидация краткого описания курса
