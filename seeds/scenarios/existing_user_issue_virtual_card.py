...
class ExistingUserIssueVirtualCardSeedsScenario(SeedsScenario):
    """
    Сценарий сидинга для существующего пользователя, который выпускает виртуальную карту к дебетовому счету
    ...
    def plan(self) -> SeedsPlan:
        ...
        Мы создаём 300 пользователей, каждый получит свой 1 дебетовый счёт.
        """
        return SeedsPlan(
            users=SeedUsersPlan(
