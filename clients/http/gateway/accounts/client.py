...
class AccountsGatewayHTTPClient(HTTPClient):
    ...
    def get_accounts_api(self, query: GetAccountsQueryDict) -> Response:
        ...
        # """
        # Почему QueryParams(**query)?
        # query — это TypedDict, т.е. словарь с предопределённой структурой.
        # QueryParams(**query) распаковывает словарь (**) в именованные параметры, инициализируя объект QueryParams. Это важно, потому что httpx.Client.get(..., params=...) принимает QueryParams.
        # Использование QueryParams повышает читаемость и явно сигнализирует: мы формируем query string, а не тело запроса.
        # Пример:
        # query = {"userId": "123"}
        # QueryParams(**query)  →  ?userId=123
        # """
